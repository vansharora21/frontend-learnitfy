                ...
                <div style={{ flex: '1 1 500px', paddingRight: '20px' }}>
                    ...
                    {/* <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px' }}>
                        <div style={{
                            ...
                            <img src="https://randomuser.me/api/portraits/women/44.jpg" alt="Tutor" style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                        </div>
                        <span style={{ fontSize: '14px' }}>Tutor: <strong>{courseData.tutor}</strong></span>
                    </div> */}

                    {/* <div style={{ display: 'flex', alignItems: 'center', marginBottom: '20px' }}>
                        <div style={{ marginRight: '10px', display: 'flex', alignItems: 'center' }}>
                            <span style={{ color: '#ffc107', fontSize: '16px' }}>★★★★★</span>
                            <span style={{ marginLeft: '5px', fontSize: '14px' }}>{courseData.rating}</span>
                        </div>
                        <span style={{ fontSize: '14px', opacity: '0.8' }}>({courseData.reviews} student reviews)</span>
                    </div> */}
